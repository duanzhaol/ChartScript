...
void GraphicsRectItem::creatCircle()
{
...
void GraphicsRectItem::setCircleVisible(bool vis)
{
    if(vis){
...
void GraphicsRectItem::setCirclePos()
{
    double radius=5;//小圆圈的半径
...
int GraphicsRectItem::IsInResizeArea(const QPointF &pos)
{
    int radius=5;
...
QRectF GraphicsRectItem::getNewPlace(int type, QPointF LT, QPointF RB)
{
...
void GraphicsRectItem::SLOT_openAttributeWidget()
{
    ...
    this->connect(attr->confirmAttr,&QPushButton::clicked,
                  this,&GraphicsRectItem::setAttr);
}

void GraphicsRectItem::setCircleColor(QColor color)
{
