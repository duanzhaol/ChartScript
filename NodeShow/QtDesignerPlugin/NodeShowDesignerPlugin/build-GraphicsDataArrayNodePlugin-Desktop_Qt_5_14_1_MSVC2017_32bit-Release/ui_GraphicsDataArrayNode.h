...
"border-radius:5px;"));
    ...
    void retranslateUi(QWidget *GraphicsDataArrayNode)
    {
        ...
        comboBox->setItemText(0, QCoreApplication::translate("GraphicsDataArrayNode", "String", nullptr));
        comboBox->setItemText(1, QCoreApplication::translate("GraphicsDataArrayNode", "long long", nullptr));
