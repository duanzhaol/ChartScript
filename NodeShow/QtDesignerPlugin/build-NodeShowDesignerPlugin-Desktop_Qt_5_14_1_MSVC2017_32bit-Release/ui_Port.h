...
public:
    ...
    void setupUi(QWidget *Port)
    {
        ...
        Port->resize(20, 20);
        outputPort = new QPushButton(Port);
        outputPort->setObjectName(QString::fromUtf8("outputPort"));
        outputPort->setGeometry(QRect(0, 0, 20, 20));
        outputPort->setMinimumSize(QSize(0, 0));
        outputPort->setMaximumSize(QSize(16777215, 16777215));
